...
def main():
    ...
    pygame.display.set_caption("Task A — Wire mode")
    ...
    mesh = Mesh()
    mesh.build(sub_hm, 20.0, 1.0, False, False, 1.0)
    ...
    while running:
        ...
        text = font.render(f"Режим: {mode} | 1:Wire 2:Solid ESC:Exit", True, (220, 220, 220))
