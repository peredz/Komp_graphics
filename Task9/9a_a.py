...
def bilinear_warp_fixed(img):
    ...
    return bilinear_warp_inverse(img, src_quad, dst_quad, (w, h))
...
if __name__ == "__main__":
    ...
    warped_fixed = bilinear_warp_fixed(img)
    cv2.imshow("9A-A Fixed Warp", warped_fixed)
    cv2.waitKey(0)
