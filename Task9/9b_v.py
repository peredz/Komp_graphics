...
def triangle_warp_delaunay_interactive(img):
    h, w = img.shape[:2]

    src_points = np.float32([
        [100, 100], [500, 120], [300, 300],
        [150, 500], [450, 450], [50, 300], [300, 50],
        [250, 250], [400, 200]
    ])
    ...
    cv2.namedWindow("9B-V Delaunay")
    cv2.setMouseCallback("9B-V Delaunay", mouse)
    ...
    while True:
        ...
        for p in dst_points:
            cv2.circle(display, tuple(p.astype(int)), 6, (0, 255, 255), -1)

        cv2.imshow("9B-V Delaunay", display)
...
if __name__ == "__main__":
    ...
    triangle_warp_delaunay_interactive(img)
